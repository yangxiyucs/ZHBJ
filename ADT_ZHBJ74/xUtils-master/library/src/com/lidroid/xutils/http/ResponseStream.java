...
/**
 * Author: wyouflf Date: 13-7-31 Time: 下午3:27
 */
public class ResponseStream extends InputStream {
	...
	public ResponseStream(HttpResponse baseResponse, String requestUrl,
			long expiry) throws IOException {
		this(baseResponse, HTTP.UTF_8, requestUrl, expiry);
	}

	public ResponseStream(HttpResponse baseResponse, String charset,
			String requestUrl, long expiry) throws IOException {
	...
	public String readString() throws IOException {
		...
		try {
			...
			if (requestUrl != null
					&& HttpUtils.sHttpCache.isEnabled(requestMethod)) {
